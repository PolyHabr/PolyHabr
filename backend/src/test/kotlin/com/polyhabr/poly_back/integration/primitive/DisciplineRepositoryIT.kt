...
class DisciplineRepositoryIT @Autowired constructor(
    val entityManager: TestEntityManager,
    val disciplineRepository: DisciplineTypeRepository
) {
    companion object {
        @Container
    ...
    @Test
    fun test() {
        val tagType = disciplineRepository.save(DisciplineType(name = "test"))
        val tagType2 = disciplineRepository.findById(tagType.id!!).get()
